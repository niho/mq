...
export declare const resource: <T, U = unknown, C = any, TO = T, UO = U>(desc: _resource.IResource<T, U, C, TO, UO>) => (options: any) => (msg: _message.IMessage) => Promise<void>;
export declare const service: <T = unknown, C = any, O = T>(desc: _service.IService<T, C, O>) => (options: any) => (msg: _message.IMessage) => Promise<void>;
